...
public class HW5_SVM {
 	...
 	for(int crossValidationIndex=0;crossValidationIndex<5;crossValidationIndex++)
 		{
 			...
 			runSVM(data,index,testFileName);
 	...
 	public static void main(String args[])
	{
  		...
  		HW5_SVM svm = new HW5_SVM();
  		svm.SVM();
  		
  	/*	System.out.println("best weights");
  		for(int i=0;i<svm.best_W.length;i++)
  			System.out.println(svm.best_W[i]);
  		*/
  		// test the TEST file
  		
			String testFile = new String("C:\\Machine Learning\\hw5\\data\\data\\test.liblinear");
			boolean print=true;
			double testAccuracy = svm.testTestFile(svm.best_W,testFile,print);
...
public void  runSVM(Data[] data, int index,String testFileName)
{
 int t=0;
	 Double best_w[] = new Double[220];
   ...
   for(int i=0;i<LearningRates.length;i++)
    {
	 ...
	 // Epochs
		...
		//CVSplit test
		 boolean print=false;
 	double cvAccuracy = testTestFile(w,testFileName,print);
...
// 	 	System.out.println("   ***BEST W  for Learning Rate " + LearningRate + " And TradeOff : " + TradeOff + " and is " + cvAccuracy);
 	...
 	System.out.println("   Cross Validation    ** F1 Accuracy for Learning Rate " + LearningRate + " And TradeOff : " + TradeOff + " is " + cvAccuracy);
 	System.out.println(" ");
    }
...
public static Double[] learnSVM(Data data[],int index,double LearningRate,int decreaseRate, Double w[],double TradeOff)
	{
